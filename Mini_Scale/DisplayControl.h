...
// Принудительная перерисовка следующего кадра Display_ShowMain.
// Вызывать после Display_ShowMessage, RunSettingsMode и других функций,
// которые рисуют поверх главного экрана. Без этого frame-skip может
// пропустить перерисовку если параметры не изменились.
